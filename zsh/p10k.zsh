# Generated by Powerlevel10k configuration wizard on 2026-01-23 at 21:09 GMT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 40 )) && branch[20,-12]="…"  # <-- this line
  ...
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION='' # setting to empty since I only use git
  # Custom prefix.
